        ...
        child: Column(
          children: <Widget>[
            ...
            Container(
              ...
              padding: const EdgeInsets.all(10.0),
              child: new Text(
                "We do not \"track\" you with our cookies.",
                style: Theme.of(context).textTheme.headline3
                )
            ),
            Container(
            ...
            Container(
              ...
              child: new RichText(
                text: new TextSpan(
                  ...
                  style: Theme.of(context).textTheme.bodyText1?.copyWith(fontSize: 18.0, color: Colors.black),
                  children: [
                    new TextSpan(
                    ...
                    new TextSpan(
                      text: "with the full copy of all of the legalese."
                    )
                  ]
                ),
              )
